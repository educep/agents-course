...
class PartyPlanningRetrieverTool(Tool):
    ...
    def __init__(self, docs, **kwargs):
        ...
        self.retriever = BM25Retriever.from_documents(docs, k=5)  # Retrieve the top 5 documents
...
source_docs = [
    Document(page_content=doc["text"], metadata={"source": doc["source"]}) for doc in party_ideas
]
